...
let rec recfind (grand_father_age, grand_son_age) =
  ...
  else recfind (grand_father_age, grand_son_age+1);;

let rec find (grand_father_age, grand_son_age) =
  if (grand_father_age <= grand_son_age)
  then (-1,-1)
  else if (recfind (grand_father_age, grand_son_age) = (-1,-1))
  then find (grand_father_age-1, grand_son_age)
  else recfind (grand_father_age, grand_son_age);;
